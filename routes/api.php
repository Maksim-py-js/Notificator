...
Route::apiResource('task_file', 'App\Http\Controllers\TaskFileController');
Route::apiResource('task_workplace_user', 'App\Http\Controllers\TaskWorkplaceUsersController');
